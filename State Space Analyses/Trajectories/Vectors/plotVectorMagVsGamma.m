function plotVectorMagVsGamma(segVectors,groupBy,whichFactors)
...
vectorMags = cell2mat(cellfun(getMagnitude, vectors, 'UniformOutput', false));
...
%create scatter plot 
scatH = gscatter(gamma,vectorMags,groups,[],[],[],'false');
