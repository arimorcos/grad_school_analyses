...
meanNetEvSameSegDist = cellfun(@mean,netEvSameSegDist);
stdNetEvSameSegDist = cellfun(@std,netEvSameSegDist);
meanSegIDSameSegDist = cellfun(@mean,segIDSameSegDist);
stdSegIDSameSegDist = cellfun(@std,segIDSameSegDist);