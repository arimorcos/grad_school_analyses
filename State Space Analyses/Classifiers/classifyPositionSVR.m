function classifierOut = classifyPositionSVR(dataCell,varargin)
%classifyPositionSVR.m Classifies the position in the maze using an SVR
%
%INPUTS
...
%extract yPos
binnedYPos = binnedDF(3,:,:);

%reshape to correct arrays 
realClass = binnedYPos(:);
