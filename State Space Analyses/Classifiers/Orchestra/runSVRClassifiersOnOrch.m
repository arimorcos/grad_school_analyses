...
save(sprintf('%s_SVR_classifierOut_netEv',fileBase),'acrossClassifier','indClassifier','groupClassifier');
...
save(sprintf('%s_SVR_classifierOut_numLeft',fileBase),'acrossClassifier','indClassifier','groupClassifier');
...
save(sprintf('%s_SVR_classifierOut_numRight',fileBase),'acrossClassifier','indClassifier','groupClassifier');