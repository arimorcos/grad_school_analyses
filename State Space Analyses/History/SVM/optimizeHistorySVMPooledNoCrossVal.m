...
currExpName = 'Optimize History SVM RBF Pooled Left Kfold 0';
...
scientist = whetlab(currExp, 'Optimize 1 seg back pooled classification using rbf svm and 0 kfold',...
...
for iterNum = 1:nIter
    ...
    accuracyLeft = poolHistoryPatternsTriplets(imTrials,'separateLeftRight',true,...
        'c',job.C,'gamma',job.gamma,'nShuffles',0,'kFold',0);
