function plotMultipleSameDiffChoiceEvSim(folder,fileStr,use_correlation)
%plotMultipleSameDiffChoiceEvSim.m Plots the across epoch
...
show_fields = 1:length(fields)-2;
% show_fields = [1:2, 6:9];
colors = lines(length(show_fields));
