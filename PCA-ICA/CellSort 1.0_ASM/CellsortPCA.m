function [mixedsig, mixedfilters, CovEvals, covtrace, movm, ...
    movtm] = CellsortPCA(fn, flims, nPCs, dsamp, outputdir, badframes, save)
% [mixedsig, mixedfilters, CovEvals, covtrace, movm, movtm] = CellsortPCA(fn, flims, nPCs, dsamp, outputdir, badframes, save)
%
% CELLSORT
...
%   from analysis
%   save - boolean of whether or not to save data
%
% Outputs:
...
%
% Eran Mukamel, Axel Nimmerjahn and Mark Schnitzer, 2009 UPDATED BY ASM
% 10/13
...
if save
    fprintf(' CellsortPCA: saving data\n');
...
%         movtm = mean(mov,1); % Average over space - edit from CAR 5/4/2013
        clear movmzeros

        c1 = (mov*mov')/size(mov,2);
        toc
        covmat = c1 - movtm*movtm';
%         covmat = c1 - movm*movm';  %%%edit from CAR 5/4/2013
        clear c1
    end
